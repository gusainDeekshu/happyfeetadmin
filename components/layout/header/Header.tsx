...
const Header = () => {
  ...
  const { showLogin, user_data,logOut} = context;
                ...
                <nav className="navbar p-0">
                  <div className="navbar__logo">
                    <Link href="/" aria-label="home page" title="logo">
                      <Image src={logoSrc} alt="Image" height={50}  priority />
                    </Link>
                  </div>
                    ...
                    <ul className="navbar__list">
                      ...
                      <li
                        className={
                          !showLogin
                            ? "d-none"
                            : "navbar__item navbar__item--has-children nav-fade"
                        }
                      >
                        <button
...
const MenuItem = ({ item }: any) => {
  ...
  return item.submenu ? (
    ...
    <li
      className={
        showLogin && item.path == "/sign-in"
          ? "d-none"
          : "navbar__item nav-fade"
      }
    >
      <Link
        href={`${item.path}`}
